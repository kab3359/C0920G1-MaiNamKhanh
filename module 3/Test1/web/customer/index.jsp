      ...
      <tr>
        ...
        <td>
          ...
          <button class=" btn btn-primary" type="button"><a class="text-white"
           style="text-decoration: none" href="customer?action=edit&id=<c:out value='${customer.getId()}'/>">Edit</a></button>

          <button class=" btn btn-danger" type="button"><a class="text-white"
          style="text-decoration: none" href="customer?action=delete&id=<c:out value='${customer.getId()}'/>">Delete</a></button>
        </td>
      </tr>
    </c:forEach>
  </table>
