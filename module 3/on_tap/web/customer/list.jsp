                ...
                <table class="table table-striped table-hover table-bordered" id="tableStudent">
                    ...
                    <c:forEach items="${listCustomer}" var="customer" >
                        <tr>
                            ...
                            <td><c:out value="${customer.getTypeId().getName()}"/></td>
                            ...
                            <td>
                                ...
                                <button id="btn-confirm" type="button" class="btn btn-danger" data-toggle="modal" data-target="#<c:out value='${customer.getId()}'/>">
                                    delete
                                </button>
                            </td>
                        </tr>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>Are you sure delete <c:out value='${customer.getId()}'/></p>
                                    </div>
